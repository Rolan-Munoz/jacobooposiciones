    ...
    <div className="fullpage p-0">
        <div className="section-top w-100 p-2">
          ...
          <div className="home-section row mt-5 justify-content-center vw-100">
            ...
            <div className="col-11 col-sm-6 py-2 px-4 mt-5 text-center">Jacobo Ocaña nació en Sevilla en 1973. Licenciado en Filología Inglesa 
          ...
          <div className="home-section row justify-content-center p-0 m-0 mt-5 mb-5 text-center">
            <div className="col-11 col-md-3 ms-2 mb-2">
              ...
              <p className="text-home-section p-4">La lengua de Cervantes y Quevedo es otro motivo de frustración a la hora de encarar un examen de oposición. Es sumamente importante controlar 
                las normas de la RAE tanto en ortografía como en las normas gramaticales de nuestra lengua.</p>
            </div>
            <div className="col-11 col-md-3 mt-4">
      ...
      <div className="fullpage p-0 main-secondary">
        <div className=" w-75 p-3 m-auto text-center">
          ...
          <p className="mt-3">kasghf sclh cdfghk asjffjsd sd fjsd fs dfjs fsjd fjsd fsjd fsdjf sdjf sjdf s
            fsjdf sjd fsjdf sdjfs djf sdjf sjdf sdjf sjd fjsd fjsd jfsdjf sjd fsjdf sdjf sdjfsf sdjfs
            sdjf sj fjs fshfjsd fhjsh fsf sdjfhjsfhjsdhfjsdhf spfsdhfjsdhfksdjfskdjfsdf df sdjf sjd fjsd fjsd jfsdjf sjd 
            fsjdf sdjf sdjfsf sdjfs
            sdjf sj fjs fshfjsd fhjsh fsf sdjfhjsfhjsdhfjsdhf spfsdhfjsdhfksdjfskdjfsdf
          </p>
      ...
      <div className="fullpage p-0 main-contact">
        <div className="home-contact w-75 p-4 m-auto text-center">
          ...
          <p className="mt-3">kasghf sclh cdfghk asjffjsd sd fjsd fs dfjs fsjd fjsd fsjd fsdjf sdjf sjdf s
            fsjdf sjd fsjdf sdjfs djf sdjf
          </p>
          <div className="w-100 my-4 pt-4 text-center">
            <a href="/pages/academia" className="home-contact-link">contactar</a>
          </div>
        </div>
      </div>
  </div>
